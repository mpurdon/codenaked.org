...
overwrite `assets-src/poster-original.png` and re-run the export — it derives
every other asset from that one file:

| Output | What | How |
|---|---|---|
| `public/images/poster.webp` | 1024w, cwebp q82 | full-size poster |
| `public/images/poster-640.webp` | 640w, cwebp q80 | small-screen srcset entry |
| `public/images/og-card.jpg` | 1200×630, q86 | crop of source rows 40–580 (the title band), scaled — the poster is 2:3 and cannot be letterboxed into a social card |
| `public/favicon.png` | 256², 128-color | square crop `(296, 436, 736, 876)` — the two characters |
| `public/apple-touch-icon.png` | 180² | same crop |
